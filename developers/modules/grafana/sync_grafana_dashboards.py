...
charts = [
    {
        ...
        'destination': '../../../helm/template-engine/templates/grafana/manifests/grafana-dashboard',
        'type': 'yaml',
        'min_kubernetes': '1.14.0-0',
        'multicluster_key': '.Values.grafana.dynamics.grafanaDashboard.multicluster.enabled'
    },
    {
...
{{- if and .Values.grafana.dynamics.grafanaDashboard.create (hasKey .Values.grafana.dynamics.grafanaDashboard "create")}}
apiVersion: integreatly.org/v1alpha1
kind: GrafanaDashboard
metadata:
  name: {{ printf "%%s-%%s" (include "common.names.fullname" .) "%(name)s" | trunc 63 | trimSuffix "-" }}
